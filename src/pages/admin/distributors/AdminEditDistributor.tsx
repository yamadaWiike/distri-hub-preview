...
export default function AdminEditDistributor() {
  ...
  const handleInputChange = (
    field: keyof DistributorProfile,
    value: string | number
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handleFileUpload = async (
    field: "npwp_file_url" | "nib_file_url" | "ktp_file_url",
    file: File
  ) => {
    try {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <SEO title="Edit Distributor" description="Edit distributor details" />
        <Navbar />
        <div className="flex">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold">
                    {distributor?.profile?.nama_bisnis || t.editDistributor}
                  </h1>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nama_bisnis", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("email_pemilik", e.target.value)
                      }
                      placeholder={t.email}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("kontak_pemilik", e.target.value)
                      }
            ...
            <TabsContent value="company">
              <Card className="p-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label htmlFor="nomor_telp_perusahaan">
                      {t.companyPhone}
                    </Label>
                    <Input
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nama_direktur", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("bentuk_usaha", value)
                      }
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("status_pkp", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("npwp_number", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nib_number", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="url"
                      value={
                        formData.website || formData.website_perusahaan || ""
                      }
                      onChange={(e) =>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("omzet", e.target.value)
                      }
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="col-span-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        handleInputChange("alamat_gudang", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("koordinat", e.target.value)
                      }
                      placeholder={t.coordinates}
                    />
                  </div>
                  <div>
                    <Label htmlFor="jumlah_armada_pengiriman">
                      {t.deliveryFleet}
                    </Label>
                    <Input
                  ...
                  <div className="col-span-2">
                    <Label htmlFor="aplikasi_pencatatan">
                      {t.recordingApp}
                    </Label>
                    <Select
                      value=""
                      onValueChange={(selectedApp) => {
                        if (selectedApp) {
                          const currentApps = formData.aplikasi_pencatatan
                            ? formData.aplikasi_pencatatan
                                .split(", ")
                                .filter((a) => a)
                            : [];
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="Zahir Accounting">
                          Zahir Accounting
                        </SelectItem>
                        ...
                        <SelectItem value="Microsoft Excel">
                          Microsoft Excel
                        </SelectItem>
                        <SelectItem value="Google Sheets">
                          Google Sheets
                        </SelectItem>
                        <SelectItem value={lang === "id" ? "Lainnya" : "Other"}>
                          {lang === "id" ? "Lainnya" : "Other"}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    {formData.aplikasi_pencatatan &&
                      formData.aplikasi_pencatatan.split(", ").filter((a) => a)
                        .length > 0 && (
                  ...
                  <div className="col-span-2">
                      ...
                      {areaSearch && (
                        <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
                          {INDONESIAN_AREAS.filter((area) =>
                            ...
                            .slice(0, 50)
                            .map((area) => {
                              const currentAreas = formData.area_distribusi
                                ? formData.area_distribusi
                                    .split(", ")
                                    .filter((a) => a)
                                : [];
                              return (
                    ...
                    {formData.area_distribusi &&
                      formData.area_distribusi.split(", ").filter((a) => a)
                        .length > 0 && (
                        <div className="flex flex-wrap gap-2 mt-2">
                          {formData.area_distribusi
                            .split(", ")
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nama_pemilik_akun", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nomor_rekening", e.target.value)
                      }
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nama_pic", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("posisi_pic", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("nomor_kontak_pic", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("email_pic", e.target.value)
                      }
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            target.parentElement!.innerHTML =
                              '<div class="flex items-center justify-center h-full bg-gray-100"><svg class="h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div>';
                          }}
                        />
